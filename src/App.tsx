...
const App = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
{mobileMenuOpen && (
  <div className="lg:hidden fixed inset-0 bg-light-bg bg-opacity-95 z-40 pt-24 px-6 overflow-y-auto">
      ...
      <div className="font-woff bg-light-bg">
        ...
        >
          <motion.div
                ...
                viewport={{ once: true }} className="order-1 lg:order-2 w-full lg:w-[50%] flex justify-center lg:justify-end px-0 lg:px-8">
            <img
          ...
          <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                viewport={{ once: true }} className="order-2 lg:order-1 w-full lg:w-[50%] leading-7 flex flex-col gap-4">
...
<section ref={aboutRef} className="py-16 padding">
  <div className="max-w-6xl mx-auto">
    ...
    >
      <h1 className="text-4xl font-bold text-light-font">About & Skills</h1>
      <motion.svg
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
            <div className="text-white translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              <h3 className="text-xl font-bold">Kyaw Mg Mg Thu</h3>
        ...
        >
          ...
          <div className="space-y-6">
            <div className="border-l-2 border-light-teal pl-4">
              <h4 className="text-lg font-semibold text-light-font">In Matriculation</h4>
              <p className="text-light-font/80">Matriculated in 2022 | Currently studying at the University of Computer Studies, Myeik.
               | 2022-Now</p>
            </div>

            <div className="border-l-2 border-light-teal pl-4">
              <h4 className="text-lg font-semibold text-light-font">Getting Started Web Developement</h4>
              <p className="text-light-font/80">Self-taught through YouTube and online courses</p>
              <ul className="list-disc pl-5 mt-2 text-light-font/80 space-y-1">
                <li>HTML, CSS, Bootstrap, JavaScript, JQuery, PHP, Laravel, Mysql at Code Lab | 2022</li>
                <li>Advanced PHP Framework Thinking, Git, GitHub at Creative Coder Myanmar | 2023</li>
                <li>Laravel Filament, Laravel Livewire,  React.js, Next.js at Youtube Platform | 2023-2024</li>
